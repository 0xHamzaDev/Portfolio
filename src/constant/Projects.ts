export const projects = [
    ...
    },
    {
        ...
        description: "A web scraping application developed to monitor and track the availability of products on e-commerce websites. The application sends real-time notifications via telegram when a tracked product is back in stock or its status is updated. The system can handle multiple websites simultaneously and includes features such as customizable tracking options, notification preferences, and a user-friendly interface for managing tracked items.",
